...
set job_name       = AMIP_TOP_TP_36years_F2010
set compset        = F2010 # F2010
...
set e3sm_tag       = master #2f91b63cfd15bf53d54f59c8fb01581b29e0a1f8
set tag_name       = E3SM_couple
...
set seconds_before_delete_bld_dir    = 3
set seconds_before_delete_run_dir    = 3
...
### DIRECTORIES
set code_root_dir               = /qfs/people/haod776
set e3sm_simulations_dir        = /compyfs/haod776/e3sm_scratch/E3SM_couple
...
### SIMULATION OPTIONS
set start_date                  = '2010-01-01' #default
...
if ( `$xmlquery_exe --value COMP_ATM` == 'datm'  ) then 
  ...
  e3sm_newline
#PMA  $xmlchange_exe --id CAM_CONFIG_OPTS --append --val='-cosp'
endif
...
cat >> user_nl_elm << EOF
 ...
 hist_fincl1 = 'FSDS','FLDS','FSA','FSR','FIRE','FSH','EFLX_LH_TOT','TSOI_10CM','H2OSOI','TV','TG','TSA','FPSN','FSM','TBOT','FSNO','SNOWDP','H2OSNO','SNORDSL','QSNOMELT','QRUNOFF','QOVER','SNOAERFRC2L','SNOAERFRCL','SNOBCFRC2L','SNOBCFRCL','SNODSTFRC2L','SNODSTFRCL','SNOOCFRC2L','SNOOCFRCL','SNOBCMCL','SNOBCMSL','SNODSTMCL','SNODSTMSL','SNOOCMCL','SNOOCMSL','BCDEP','DSTDEP','OCDEP','SNOW','RAIN'

 fsnowoptics = '/compyfs/inputdata/lnd/clm2/snicardata/snicar_optics_5bnd_mam_c211006.nc'
 fsurdat = '/compyfs/haod776/e3sm_scratch/E3SM_couple/surface_data/surfdata_0.5x0.5_simyr2010_c221230_new_TP.nc'
...
#PMA copy NN file to run directory

#cp  $code_root_dir/$tag_name/model_config.txt  $case_run_dir/.
