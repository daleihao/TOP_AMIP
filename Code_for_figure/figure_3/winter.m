...
plot_global_map(lats, lons, TSA_bias_annual, -4, 4,"PP - Benchmark",0,1,'(a)');
colormap(ax1, colors);
cb = colorbar;
cb.FontSize = 10;
cb.FontWeight = 'bold';
...
plot_global_map(lats, lons, TSA_Dif_TP_annual, -1, 1,"TOP\_TP - PP",0,0,'(b)');
colormap(ax2, colors);
cb = colorbar;
cb.FontSize = 10;
cb.FontWeight = 'bold';
...
plot_global_map(lats, lons, PREC_bias_annual, -4, 4,"",0,1,'(c)');
colormap(ax3, colors);
cb = colorbar;
cb.FontSize = 10;
cb.FontWeight = 'bold';
...
plot_global_map(lats, lons, PREC_Dif_TP_annual, -0.5, 0.5,"",0,0,'(d)');
colormap(ax4, colors);
cb = colorbar;
cb.FontSize = 10;
cb.FontWeight = 'bold';
...
plot_global_map(lats, lons, TSA_bias_summer, -4, 4,"",0,1,'(e)');
colormap(ax5, colors);
cb = colorbar;
cb.FontSize = 10;
cb.FontWeight = 'bold';
...
plot_global_map(lats, lons, TSA_Dif_TP_summer, -1, 1,"",0,0,'(f)');
colormap(ax6, colors);
cb = colorbar;
cb.FontSize = 10;
cb.FontWeight = 'bold';
...
plot_global_map(lats, lons, PREC_bias_summer, -4, 4,"",1,1,'(g)');
colormap(ax7, colors);
cb = colorbar;
cb.FontSize = 10;
cb.FontWeight = 'bold';
...
plot_global_map(lats, lons, PREC_Dif_TP_summer, -0.5, 0.5,"",1,0,'(h)');
colormap(ax8, colors);
cb = colorbar;
cb.FontSize = 10;
cb.FontWeight = 'bold';

print(gcf, '-dtiff', '-r300', ['../tif/figure_3_winter_remote_effects.tif']);
