...
load('inTP.mat');
filters = lats> 20 & lats <42 & lons > 60 & lons < 160;
...
for season_i = 1:5
    ...
    data_all(1,season_i,[5 7 9]) = cal_RMSE2(FSA_Obs, FSA_PP);
    data_all(1,season_i,[6 8 10]) = cal_RMSE2(FSA_Obs, FSA_TOP);
    ...
    data_all(2,season_i,[5 7 9]) = cal_RMSE2(Albedo_Obs, Albedo_PP);
    data_all(2,season_i,[6 8 10]) = cal_RMSE2(Albedo_Obs, Albedo_TOP);
    ...
    data_all(3,season_i,[5 7 9]) = cal_RMSE2(LH_Obs, LH_PP);
    data_all(3,season_i,[6 8 10]) = cal_RMSE2(LH_Obs, LH_TOP);
    ...
    data_all(4,season_i,[5 7 9]) = cal_RMSE2(FSH_Obs, FSH_PP);
    data_all(4,season_i,[6 8 10]) = cal_RMSE2(FSH_Obs, FSH_TOP);
    ...
    data_all(5,season_i,[5 7 9]) = cal_RMSE2(FSNO_Obs, FSNO_PP);
    data_all(5,season_i,[6 8 10]) = cal_RMSE2(FSNO_Obs, FSNO_TOP);
...
%     data_all(1,season_i,[5 7 9]) = cal_RMSE2(FSA_Obs, FSA_PP);
%     data_all(1,season_i,[6 8 10]) = cal_RMSE2(s_Obs, FSA_TOP_TP);
    ...
    data_all(6,season_i,[5 7 9]) = cal_RMSE2(TSA_Obs, TSA_PP);
    data_all(6,season_i,[6 8 10]) = cal_RMSE2(TSA_Obs, TSA_TOP);
    ...
    data_all(7,season_i,[5 7 9]) = cal_RMSE2(PREC_Obs, PREC_PP);
    data_all(7,season_i,[6 8 10]) = cal_RMSE2(PREC_Obs, PREC_TOP);
