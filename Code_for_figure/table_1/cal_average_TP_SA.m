...
for season_i = 1:5
    ...
    data_all(1,season_i,[6 8 10]) = cal_RMSE2(FSA_Obs, FSA_TOP_TP);
    ...
    data_all(2,season_i,[6 8 10]) = cal_RMSE2(Albedo_Obs, Albedo_TOP_TP);
    ...
    data_all(3,season_i,[6 8 10]) = cal_RMSE2(LH_Obs, LH_TOP_TP);
    ...
    data_all(4,season_i,[6 8 10]) = cal_RMSE2(FSH_Obs, FSH_TOP_TP);
    ...
    data_all(5,season_i,[6 8 10]) = cal_RMSE2(FSNO_Obs, FSNO_TOP_TP);
...
%     data_all(1,season_i,[6 8 10]) = cal_RMSE2(s_Obs, FSA_TOP_TP);
    ...
    data_all(6,season_i,[6 8 10]) = cal_RMSE2(TSA_Obs, TSA_TOP_TP);
    ...
    data_all(7,season_i,[6 8 10]) = cal_RMSE2(PREC_Obs, PREC_TOP_TP);
