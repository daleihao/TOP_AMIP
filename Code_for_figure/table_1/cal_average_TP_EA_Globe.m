...
for season_i = 1:5
    ...
    data_all(1,season_i,[6 8 10]) = cal_RMSE3(FSA_Obs, FSA_TOP);
    ...
    data_all(2,season_i,[6 8 10]) = cal_RMSE3(Albedo_Obs, Albedo_TOP);
    ...
    data_all(3,season_i,[6 8 10]) = cal_RMSE3(LH_Obs, LH_TOP);
    ...
    data_all(4,season_i,[6 8 10]) = cal_RMSE3(FSH_Obs, FSH_TOP);
    ...
    data_all(5,season_i,[6 8 10]) = cal_RMSE3(FSNO_Obs, FSNO_TOP);
