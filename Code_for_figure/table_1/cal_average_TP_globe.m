...
for season_i = 5
    ...
    data_all(1,season_i,[6 8 10]) = cal_RMSE(FSA_Obs, FSA_TOP);
    ...
    data_all(2,season_i,[6 8 10]) = cal_RMSE(Albedo_Obs, Albedo_TOP);
    ...
    data_all(3,season_i,[6 8 10]) = cal_RMSE(LH_Obs, LH_TOP);
    ...
    data_all(4,season_i,[6 8 10]) = cal_RMSE(FSH_Obs, FSH_TOP);
    ...
    data_all(5,season_i,[6 8 10]) = cal_RMSE(FSNO_Obs, FSNO_TOP);
...
%     data_all(1,season_i,[5 7 9]) = cal_RMSE(FSA_Obs, FSA_PP);
%     data_all(1,season_i,[6 8 10]) = cal_RMSE(s_Obs, FSA_TOP_TP);
    ...
    data_all(6,season_i,[6 8 10]) = cal_RMSE(TSA_Obs, TSA_TOP);
    ...
    data_all(7,season_i,[6 8 10]) = cal_RMSE(PREC_Obs, PREC_TOP);
