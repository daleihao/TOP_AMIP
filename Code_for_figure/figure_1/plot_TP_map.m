function plot_TP_map(lats, lons, sw_total, min_clr, max_clr, title_text, isxticklabel, isyticklabel,sub_text)
axis equal
...
if isxticklabel == 1 && isyticklabel == 1
    m_grid('tickdir','in','linestyle','--', 'gridcolor',[0.7 0.7 0.7],...
        'fontsize',10,'tickstyle','dd','xtick',6,'ytick',6);
    
elseif isxticklabel == 0 && isyticklabel == 1
    m_grid('tickdir','in','linestyle','--', 'gridcolor',[0.7 0.7 0.7],...
        'fontsize',10,'tickstyle','dd','xtick',6,'ytick',6, 'xticklabels',[]);
    
elseif isxticklabel == 1 && isyticklabel == 0
    m_grid('tickdir','in','linestyle','--', 'gridcolor',[0.7 0.7 0.7],...
        'fontsize',10,'tickstyle','dd','xtick',6,'ytick',6,'yticklabels',[]);
    
else
    m_grid('tickdir','in','linestyle','--', 'gridcolor',[0.7 0.7 0.7],...
        'fontsize',10,'tickstyle','dd','xtick',6,'ytick',6, 'xticklabels',[],'yticklabels',[]);
...
m_text(68.5,27,sub_text,'fontsize',12,'fontweight','bold')
%colorbar
