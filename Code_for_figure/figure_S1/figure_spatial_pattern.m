...
for season_i = 1:5 %% annual
    ...
    plot_TP_map(lats, lons, Albedo_dif_Globe, -0.05, 0.05,"\Delta in land surface albedo (Unitless)",0,1,'(a)');
    colormap(ax1, colors);
    cb = colorbar;
    cb.FontSize = 10;
    cb.FontWeight = 'bold';
    ...
    plot_TP_map(lats, lons, FSA_dif_Globe, -15, 15,"\Delta in net solar radiation (W/m^2)",0,0,'(b)');
    colormap(ax2, colors);
    cb = colorbar;
    cb.FontSize = 10;
    cb.FontWeight = 'bold';
    ...
    plot_TP_map(lats, lons, LH_dif_Globe, -8, 8,"\Delta in latent heat flux (W/m^2)",0,1,'(c)');
    colormap(ax3, colors);
    cb = colorbar;
    cb.FontSize = 10;
    cb.FontWeight = 'bold';
    ...
    plot_TP_map(lats, lons, FSH_dif_Globe, -8, 8,"\Delta in sensible heat flux (W/m^2)",0,0,'(d)');
    colormap(ax4, colors);
    cb = colorbar;
    cb.FontSize = 10;
    cb.FontWeight = 'bold';
    ...
    plot_TP_map(lats, lons, FSNO_dif_Globe, -10, 10,"\Delta in snow cover fraction (%)",0,1,'(e)');
    colormap(ax5, colors);
    cb = colorbar;
    cb.FontSize = 10;
    cb.FontWeight = 'bold';
    ...
    plot_TP_map(lats, lons, SWE_dif_Globe, -20, 20,"\Delta in snow water equivalent (mm)",0,0,'(f)');
    colormap(ax6, colors);
    cb = colorbar;
    cb.FontSize = 10;
    cb.FontWeight = 'bold';
    ...
    plot_TP_map(lats, lons, TSA_dif_Globe, -1, 1,"\Delta in air temperature (K)",1,1,'(g)');
    colormap(ax7, colors);
    cb = colorbar;
    cb.FontSize = 10;
    cb.FontWeight = 'bold';
    ...
    plot_TP_map(lats, lons, PREC_dif_Globe, -0.5, 0.5,"\Delta in precipitation (mm/day)",1,0,'(h)');
    colormap(ax8, colors);
    cb = colorbar;
    cb.FontSize = 10;
    cb.FontWeight = 'bold';
    ...
    %% %% output
print(gcf, '-dtiff', '-r300', ['../tif/figure_S1_Globe_spatial_pattern_' season_name '.tif'])
